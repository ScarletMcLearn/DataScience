...
hover_tool_1 = HoverTool(renderers=[ia1, ib1], tooltips=[('X', '@x{"%dth %B - %I:%M:%S %p"}'), ('Y', '@y1')], formatters={'@x': 'datetime'})

# Add the HoverTool to the figure
p.add_tools(hover_tool_1)

hover_tool_2 = HoverTool(renderers=[ia2, ib2], tooltips=[('X', '@x{"%dth %B - %I:%M:%S %p"}'), ('Y', '@AAMRANET')], formatters={'@x': 'datetime'})
p.add_tools(hover_tool_2)


hover_tool_3 = HoverTool(renderers=[ia3, ib3], tooltips=[('X', '@x{"%dth %B - %I:%M:%S %p"}'), ('Y', '@AAMRATECH')], formatters={'@x': 'datetime'})
p.add_tools(hover_tool_3)

hover_tool_4 = HoverTool(renderers=[ia4, ib4], tooltips=[('X', '@x{"%dth %B - %I:%M:%S %p"}'), ('Y', '@ABBANK')], formatters={'@x': 'datetime'})
p.add_tools(hover_tool_4)
