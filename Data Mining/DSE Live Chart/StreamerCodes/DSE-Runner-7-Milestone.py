...
p, l2 = draw_shape_line(x_col_name='x', y_col_name='AAMRANET', source=source, figure=p, label='AAMRANET', shape='s')

p, l3 = draw_shape_line(x_col_name='x', y_col_name='AAMRATECH', source=source, figure=p, label='AAMRATECH', shape='t')

p, l4 = draw_shape_line(x_col_name='x', y_col_name='ABBANK', source=source, figure=p, label='ABBANK', shape='h')
