...
company_lst = company_lst_1 + company_lst_2

company_lst_2_symb = ['c+']*len(company_lst_2) 
company_symbol_lst = company_symbol_lst + company_lst_2_symb # + new_symb_3  # + new_symb_2
# + new_symb 
