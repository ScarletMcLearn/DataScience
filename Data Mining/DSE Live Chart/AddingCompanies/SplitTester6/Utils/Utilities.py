...
def updated_draw_shape_line(x_col_name, y_col_name, source, figure, label, shape, company_lst, line_no, color):
    # mapper = linear_cmap(field_name=y_col_name, palette=Turbo256, 
    #                  low=100, high=0)
    i2 = updated_draw_shape(x_col_name=x_col_name, y_col_name=y_col_name, source=source, figure=figure, shape=shape, size=30, fill_color=color, border_color='white', border_width=3, alpha=0.55, line_smoothing=0.9, line_join='round', line_cap='round', line_alpha=0.6, line_dash='4 4', )

    i3 = updated_draw_shape(x_col_name=x_col_name, y_col_name=y_col_name, source=source, figure=figure, shape='l', size=30, fill_color='blue', border_color='white', border_width=6, alpha=0.5, line_smoothing=0.9, line_join='round', line_cap='round', line_alpha=0.6, line_dash='10 10', )
