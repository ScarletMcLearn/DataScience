...
# l1, ia1, ib1 = updated_draw_shape_line(x_col_name='x', y_col_name='y1', source=source, figure=p, label='Testy time', shape='c')




# l2, ia2, ib2 = updated_draw_shape_line(x_col_name='x', y_col_name='AAMRANET_PC', source=source, figure=p, label='AAMRANET', shape='s')

# l5, ia5, ib5 = updated_draw_shape_line(x_col_name='x', y_col_name='UNITED_POWER_GENERATION_PC', source=source, figure=p, label='UNITED_POWER_GENERATION', shape='s')

# l6, ia6, ib6 = updated_draw_shape_line(x_col_name='x', y_col_name='SALVO_CHEMICAL_PC', source=source, figure=p, label='SALVO_CHEMICAL', shape='s')

# l7, ia7, ib7 = updated_draw_shape_line(x_col_name='x', y_col_name='RAHIMA_FOOD_CORP_PC', source=source, figure=p, label='RAHIMA_FOOD_CORP', shape='s')


from Utils.Glyphs import glyph_renderer
l1, ia1, ib1, l2, ia2, ib2, l5, ia5, ib5, l6, ia6, ib6, l7, ia7, ib7, l3, ia3, ib3, l4, ia4, ib4 = glyph_renderer(source, figure=p)



# l3, ia3, ib3, l4, ia4, ib4
...
hover_tool_2 = draw_hovertools(ia2, ib2)
